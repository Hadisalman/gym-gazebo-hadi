...
if __name__ == '__main__':
    ...
    env = gym.make('GazeboCircuit2cSnakeMonsterCameraNnEnv-v0')
    outdir = '/tmp/gazebo_gym_experiments/'

    continue_execution = False
    #fill this if continue_execution=True
    weights_path = '/tmp/snakemonster_c2c_dqn_ep200.h5' 
    monitor_path = '/tmp/snakemonster_c2c_dqn_ep200'
    params_json  = '/tmp/snakemonster_c2c_dqn_ep200.json'
            ...
            if done:
                ...
                if not last100Filled:
                    ...
                    if (epoch)%100==0: 
                        ...
                        deepQ.saveModel('/tmp/snakemonster_c2c_dqn_ep'+str(epoch)+'.h5')
                        env.monitor.flush()
                        copy_tree(outdir,'/tmp/snakemonster_c2c_dqn_ep'+str(epoch))
                        ...
                        with open('/tmp/snakemonster_c2c_dqn_ep'+str(epoch)+'.json', 'w') as outfile:
