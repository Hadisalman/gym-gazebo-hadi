...
#    ...:     eps = npy.array(hist[i])               
#    ...:     plt.scatter(eps[:,0],eps[:,1],c=eps[:,2],s=60,vmin=0.3,vmax=2,edgecolor='')
#    ...:     #ax.scatter3D(eps[:,0],eps[:,1],0.,c=eps[:,2],s=60,vmin=0.3,vmax=2,edgecolor=None)
#    ...: plt.xlabel("X Axis")          
#    ...: plt.ylabel("Y Axis")                    
#    ...: plt.title("Plot of policy activations over space.")
#    ...: plt.show() 
