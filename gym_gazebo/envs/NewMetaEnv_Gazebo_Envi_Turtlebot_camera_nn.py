...
class MetaGazeboEnviTurtlebotCameraNnEnv(gazebo_env.GazeboEnv):
    ...
    def __init__(self):
        ...
        self.weight_file_1 = '/home/hadis/Hadi/Reinforcement_Learning/gym-gazebo-hadi/examples/scripts_turtlebot/camera_dqn/Path1_Model_File.h5'
        self.weight_file_2 = '/home/hadis/Hadi/Reinforcement_Learning/gym-gazebo-hadi/examples/scripts_turtlebot/camera_dqn/Path2_Old_Model_File.h5'

        self.model1 = load_model(self.weight_file_1)
        self.model2 = load_model(self.weight_file_2)
        
        print("HELLOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO")
        print(self.model1.input)
        embed()
...
# Set up the code for: 
    ...
    def create_model(self, weight_file):
        ...
        model.add(Activation('relu'))
        nb_actions_low = 3
        model.add(Dense(nb_actions_low))
